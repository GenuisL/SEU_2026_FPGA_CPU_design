...
set_property -dict {PACKAGE_PIN C19 IOSTANDARD LVCMOS33} [get_ports clk]

set_property -dict {PACKAGE_PIN P4 IOSTANDARD LVCMOS33} [get_ports rst]
set_property -dict {PACKAGE_PIN F4 IOSTANDARD LVCMOS33} [get_ports key[1]]
set_property -dict {PACKAGE_PIN H4 IOSTANDARD LVCMOS33} [get_ports key[2]]
set_property -dict {PACKAGE_PIN K4 IOSTANDARD LVCMOS33} [get_ports key[3]]
set_property -dict {PACKAGE_PIN M3 IOSTANDARD LVCMOS33} [get_ports key[4]]

set_property -dict {PACKAGE_PIN Y4 IOSTANDARD LVCMOS33} [get_ports led[1]]
set_property -dict {PACKAGE_PIN V4 IOSTANDARD LVCMOS33} [get_ports led[2]]
set_property -dict {PACKAGE_PIN T3 IOSTANDARD LVCMOS33} [get_ports led[3]]
set_property -dict {PACKAGE_PIN T4 IOSTANDARD LVCMOS33} [get_ports led[4]]
set_property -dict {PACKAGE_PIN P5 IOSTANDARD LVCMOS33} [get_ports led[5]]
...
set_property -dict {PACKAGE_PIN F3 IOSTANDARD LVCMOS33} [get_ports led[8]]
